...
public class UserController {
    ...
    @PostMapping("/user")
    public ResponseEntity<BaseResponse<AddUserResponse>> add(@RequestBody AddUserRequest request){
        BaseResponse<AddUserResponse> rsp = new BaseResponse<>(ErrorMessage.SUCCESS, service.add(request));
